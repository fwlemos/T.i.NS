...
- [x] 1.0 Implement Core CRM Layout & Routing (Strict Design System Compliance)
...
- [x] 2.0 Implement Kanban View (Visual & Functional Overhaul)
...
- [x] 3.0 Implement List View Table (Design System Aligned)
...
- [x] 4.0 Implement Opportunity Detail Page (3-Column Layout)
...
- [ ] 5.0 Final Polish & Responsive Verification
  ...
  - [x] 5.2 Verify "New Opportunity" button visibility on all screen sizes.
